  ...
  <div id="main" class="hander-car">
  	<div class="store-content">
  		<div class="cart-box">
            ...
            <router-link tag="span" to='/Checkout' class="jianguo-blue-main-btn big-main-btn js-checkout" :class='{"disabled-btn":ckeckCount<=0}'>
              <a>现在结算</a>
            </router-link>
  				</div>
  			</div>
...
<script>
  export default{
    computed: {
      ...
      //总数
      ckeckCount(){
        return this.$store.getters.ckeckCount
      }
    },
    methods:{
      delCarPanelData(id){
