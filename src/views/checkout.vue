  				...
  				<div class="box-inner js-checkout-address-panel ">
  					<div class="address-common-table js-multiple-address-panel">
  						<ul class="address-item-list clear js-address-item-list">
  							<li class="js-choose-address" @click="chooseReceive(index)" :class="{'selected-address-item':receiveIndex == index}" v-for="(item,index) in receiveInfo" :key='index'>
  		...
  		<div class="gray-box">
  			...
  			<div class="box-inner ui-goods-cart">
  				...
  				<div class="cart-table">
  					<div class="cart-group js-cart-group">
  						<div class="cart-items" v-for="(item,index) in checkGoods" :key='index'>
                    ...
                    <img :src="item.ali_image"></a>
  							...
  							<div class="name hide-row">
  								<div class="name-cell">
  									<a href="javascript:;" :title="item.title+'('+item.spec_json.show+')'" target="_blank">{{item.title}}({{item.spec_json.show}})</a>
  								</div>
  							</div>
  							<div class="subtotal">
  			...
  			<div class="box-inner">
  				<div class="order-discount-line">
  					<p> 商品总计： <span>¥ {{ckeckPrice}}.00</span> </p>
            ...
            <span class="prices fn-right">应付金额： <em>¥ {{ckeckPrice + freight}}.00</em></span>
  				</div>
  			</div>
  		</div>
  	</div>
...
<script>
  ...
  export default{
    ...
    computed:{
      ...
      //总价
      ckeckPrice(){
        return this.$store.getters.ckeckPrice
      },
      //运费
      freight(){
        let freight = 8
        if(this.ckeckPrice > 88){
          freight = 0
        }
        return freight
      },
