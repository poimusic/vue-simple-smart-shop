		...
		<div class="item-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					<div class="thumbnail">
						<ul>
							<li :class="{'on':index==imgIndex}" @click="tableImg(index)" v-for="(image,index) in itemsInfo.ali_images" :key="index">
                <img :src="image"></li>
						</ul>
					</div>
					<div class="thumb">
						<ul>
							<li :class="{'on':index==imgIndex}" v-for="(image,index) in itemsInfo.ali_images" :key="index">
                <img :src="image"></li>
						</ul>
					</div>
				</div>
			...
			<div class="banner">
				...
				<div class="sku-dynamic-params-panel">
					<div class="sku-dynamic-params clear">
						<span class="params-name">款式</span>
