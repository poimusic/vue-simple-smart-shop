  	...
  	<div class="nav-global">
          ...
          <carPanel></carPanel>
  			...
  			<ul class="nav-list">
  				...
  				<li><a href="javascript:;">重磅新品</a></li>
  				<li><a href="javascript:;">名作之壁</a></li>
  				<li><a href="javascript:;">新番风云</a></li>
  				<li><a href="javascript:;">应用下载</a></li>
  				<li><a href="javascript:;">官方论坛</a></li>
  				<li><a href="javascript:;">云搜索</a></li>
  			</ul>
  		</div>
  	</div>
  		...
  		<div class="nav-sub-wrapper">
  			<div class="container">
  				<ul class="nav-list">
  					...
  					<li v-on:mouseover='add' v-on:mouseout='del'><router-link to='mPhone'>商品</router-link></li>
