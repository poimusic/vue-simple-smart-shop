            ...
            <div class="dialog-inner js-address-add">
              <div class="save-address-box">
                <div class="address-form">
                  ...
                  <div class="dialog-blue-btn big-main-btn js-verify-address" :class="{'disabled-btn':!right}" @click="submitReceive">
                    <a>保存</a>
                  </div>
                </div>
              </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      inspectPhone () {
        if (this.receive.phone.length!=11 || this.receive.phone.length!=11) {
